    ...
    <div class="container">
        ...
        <table>
            ...
            <tbody id="eventsTableBody">
                ...
                $sql = "SELECT Bidder_Id, F_Name, L_Name, UserName, Position, Email, Address, NIC, Phone_No, Password FROM registeredbidder";
                ...
                if ($result->num_rows > 0) {
                    ...
                    while ($row = $result->fetch_assoc()) {
                        echo "<tr>
                                ...
                                <td>" . $row["Password"] . "</td>
                                <td>
                                    <button onclick=\"readInfo('" . $row["F_Name"] . "', '" . $row["L_Name"] . "', '" . $row["UserName"] . "', '" . $row["Position"] . "', '" . $row["Email"] . "', '" . $row["Address"] . "', '" . $row["NIC"] . "', '" . $row["Phone_No"] . "', '" . $row["Password"] . "')\"><i class='fa-regular fa-eye'></i></button>
                                    <button onclick=\"editInfo(" . $row["Bidder_Id"] . ", '" . $row["F_Name"] . "', '" . $row["L_Name"] . "', '" . $row["UserName"] . "', '" . $row["Position"] . "', '" . $row["Email"] . "', '" . $row["Address"] . "', '" . $row["NIC"] . "', '" . $row["Phone_No"] . "', '" . $row["Password"] . "')\"><i class='fa-regular fa-pen-to-square'></i></button>
