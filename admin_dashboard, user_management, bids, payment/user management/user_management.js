document.addEventListener('DOMContentLoaded', function() {
    ...
    const formInputFields = [fName, lName, uName, position, email, address, nic, phone, password];
    ...
    window.readInfo = function(fname, lname, uname, positionValue, emailValue, addressValue, nicValue, phoneValue, passwordValue) {
        fName.value = fname;
        lName.value = lname;
        uName.value = uname;
    ...
    window.editInfo = function(userId, fname, lname, uname, positionValue, emailValue, addressValue, nicValue, phoneValue, passwordValue) {
        fName.value = fname;
        lName.value = lname;
        uName.value = uname;
        position.value = positionValue;
